...
class Constants:
    ...
    def calculate_c10_list(self, c5, c11_list):
        ...
        for i in range(len(self.primes)):
            ...
            term = sum_l / math.log(abs(self.alpha)) + c5
    ...
    def calculate_Nt(self, t, C5t_list, d0, d1):
        ...
        for t in range(2, self.num_terms + 1):
            ...
            denominator = math.log(min(abs(alpha_over_beta), self.alpha))
    ...
    def calculate_Dt(self, t, Nt_list, C5t_list, d0, d1):
        coefficient = 1.4 * (30 ** (len(self.primes)+5)) * ((len(self.primes)+2) ** 4.5) * 4
